...
modelPath = r'E:\opencv python\Traffic-Sign-Recognition\03-Classification\Models'
model = keras.models.load_model(modelPath + '/TSModel5.h5')

ImagesFilePath = r'E:\opencv python\Traffic-Sign-Recognition\TS Sences\Sences'
